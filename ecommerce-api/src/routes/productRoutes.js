...
router.post('/products', authMiddleware, isAdministrator, createProduct);
router.put('/products/:id', authMiddleware, isAdministrator, updateProduct);
router.delete('/products/:id', authMiddleware, isAdministrator, deleteProduct);
