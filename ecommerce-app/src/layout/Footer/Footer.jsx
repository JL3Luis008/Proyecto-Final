            ...
            <div className="footer-content">
              ...
              <div className="footer-section">
                ...
                <p className="footer-description">
                  La mayor tienda online de videojuegos y consolas retro. Ofrecemos los mejores productos garantizados y probados para que tu solamente disfrutes el jugar con tus clasicos preferidos ademas
                  contamos con un excelente servicio al cliente.
                </p>
              ...
              <div className="footer-section">
                ...
                <ul>
                  ...
                  <li>
                    <Link to="#">video juegos</Link>
                  </li>
                  <li>
                    <Link to="#">gadgets y perifericos </Link>
                  </li>
                  <li>
                    <Link to="#">Coleccionables</Link>
                  </li>
                  <li>
                    <Link to="#"> y mas...</Link>
                  </li>
        ...
        <div className="container">
          <div className="footer-bottom-content">
            <p className="copyright">
              &copy; {new Date().getFullYear()} Retro-Bits.com Todos los derechos
              reservados.
            </p>
